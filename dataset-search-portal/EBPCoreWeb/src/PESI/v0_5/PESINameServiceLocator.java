...
public class PESINameServiceLocator extends org.apache.axis.client.Service implements PESI.v0_5.PESINameService {
    ...
    public PESI.v0_5.PESINameServicePortType getPESINameServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public PESI.v0_5.PESINameServicePortType getPESINameServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            PESI.v0_5.PESINameServiceBindingStub _stub = new PESI.v0_5.PESINameServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (PESI.v0_5.PESINameServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                PESI.v0_5.PESINameServiceBindingStub _stub = new PESI.v0_5.PESINameServiceBindingStub(new java.net.URL(PESINameServicePort_address), this);
                _stub.setPortName(getPESINameServicePortWSDDServiceName());
                return _stub;
            }
        }
