...
public class AphiaNameServicePortTypeProxy implements aphia.v1_0.AphiaNameServicePortType {
  private String _endpoint = null;
  private aphia.v1_0.AphiaNameServicePortType aphiaNameServicePortType = null;
  ...
  private void _initAphiaNameServicePortTypeProxy() {
    try {
      aphiaNameServicePortType = (new aphia.v1_0.AphiaNameServiceLocator()).getAphiaNameServicePort();
  ...
  public aphia.v1_0.AphiaNameServicePortType getAphiaNameServicePortType() {
    if (aphiaNameServicePortType == null)
      _initAphiaNameServicePortTypeProxy();
  ...
  public aphia.v1_0.AphiaRecord getAphiaRecordByExtID(java.lang.String id, java.lang.String type) throws java.rmi.RemoteException{
    if (aphiaNameServicePortType == null)
      _initAphiaNameServicePortTypeProxy();
  ...
  public aphia.v1_0.AphiaRecord[] getAphiaRecordsByDate(java.lang.String startdate, java.lang.String enddate, boolean marine_only, int offset) throws java.rmi.RemoteException{
    if (aphiaNameServicePortType == null)
      _initAphiaNameServicePortTypeProxy();
  ...
  public aphia.v1_0.AphiaRecord[] getAphiaChildrenByID(int aphiaID, int offset, boolean marine_only) throws java.rmi.RemoteException{
    if (aphiaNameServicePortType == null)
      _initAphiaNameServicePortTypeProxy();
    return aphiaNameServicePortType.getAphiaChildrenByID(aphiaID, offset, marine_only);
  }
  
  public aphia.v1_0.AphiaRecord[][] matchAphiaRecordsByNames(java.lang.String[] scientificnames, boolean marine_only) throws java.rmi.RemoteException{
    if (aphiaNameServicePortType == null)
      _initAphiaNameServicePortTypeProxy();
